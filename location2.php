...
<div class="location">
    <div class="branch-locations">
        <div class="branches" id="Alaminos">
            <h4>Alaminos Laguna Branch</h4>
            <p>JP Rizal St. Brgy I- Poblacion, Alaminos, Laguna (Plaza, Near Munisipyo of Alaminos)</p>
        </div>

        <div class="branches" id="Los-Banos">
            <h4>Los Banos Laguna</h4>
            <p>Kalye Ekis Batong Malake Los Banos ,Laguna</p>
        </div>
        <div class="branches" id="San-pablo">
            <h4>San Pablo Laguna</h4>
            <p>Rizal Avenue Brgy.VII-D San Pablo,Laguna</p>
        </div>
        <div class="branches" id="Kalinga">
            <h4>Tabuk Kalinga</h4>
            <p>Purok 6 Bulanao Tabuk City, Kalinga</p>
        </div>
        <div class="branches" id="Batangas">
            <h4>Sto. Tomas Batangas</h4>
            <p>8 Governor A. Carpio Ave, Brgy San Pedro. Sto. Tomas City, Batangas</p>
        </div>
    </div>
    ...
    <!-- <div class="parent">
        ...
        <div class="ex1" id="alaminos">
            <div class="card"  >
                <h3 class="text" >Alaminos Laguna Branch</h3>
        ...
        <div class="ex1" id="losbanos">
            <div class="card">
                <h3 class="text" >Los Banos Laguna</h3>
        ...
        <div class="ex1" id="kalinga">
            <div class="card">
                <h3 class="text">Tabuk Kalinga</h3>
        ...
        <div class="ex1"  id="sanpablo">
            <div class="card">
                <h3 class="text" >San Pablo Laguna</h3>
        ...
        <div class="ex1" id="stotomas">
            <div class="card">
                <h3 class="text" >Sto. Tomas Batangas</h3>
